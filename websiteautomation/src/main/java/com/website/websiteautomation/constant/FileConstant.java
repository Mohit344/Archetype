package com.website.websiteautomation.constant;
...
public class FileConstant {
 ...
 public static final String inputlogin ="./src/test/resources/Testdata/inputlogin.xlsx";
    ...
    public static final String testdata="./src/test/resources/testdata/testData.xlsx";
    ...
    public static final String findlocator="./src/test/resources/locators/locators.properties";
